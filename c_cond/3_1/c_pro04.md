...
数学で以上以下，より大きいより小さいをやったことがあると思います．同じようにプログラムでもそれを用いることがあります．

入力した整数の符号を判定するプログラムを以下に示す[if_pn.c](if_pn.c)．
...
|  | 書き方 | 機能 |
| - | - | - |
| より小さいときに実行 | n < m | nがmより小さいとき1，大きいときは0を出力する制御式 |
| より大きいときに実行 | n > m | nがmより大きいとき1，小さいときは0を出力する制御式 |
| 以下のときに実行 | n <= m | nがm以下のとき1，以上のときは0を出力する制御式 |
| 以上のときに実行 | n >= m | nがm以上のとき1，以下のときは0を出力する制御式 |

## else if

[if_pn.c](if_pn.c)では`else if`というものがでてきました．これは以下のようなフローチャートとなる．

![else_if](else_if.png)

`else if`は枠で囲まれている部分のことで「0じゃないとき，もし0より大きいか判別」という意味です．

## 練習問題

### 練習問題1

* 下のような絶対値を返すプログラムを作成してください．
* 見本は[`practice3_1_1.c`](practice3_1_1.c)に記載してあります．
...
* 下のような一番大きい数を返すプログラムを作成してください
* if文を使って大きい数を返してください．
* 見本は[`practice3_1_2.c`](practice3_1_2.c)に記載してあります．

```shell
3つの整数を入力してください：7 5 10
一番大きい値は10です．
```

## 今回の課題

* 下のような一番小さい数を返すプログラムを作成してください
* if文を使って小さい数を返してください．
...
## 追加課題
* [`プログラミング練習 if文.pdf`](プログラミング練習 if文.pdf)を参照してください.
* 提出は不要です.
